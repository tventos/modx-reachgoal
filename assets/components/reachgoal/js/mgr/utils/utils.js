Reachgoal.utils.renderActions = function (value, props, row) {
    var res = [];
    ...
    for (var i in row.data.actions) {
        ...
        item = String.format(
            '<li class="{0}"><button class="reachgoal-btn reachgoal-btn-default {1}" action="{2}" title="{3}"></button></li>',
    ...
    return String.format(
        '<ul class="reachgoal-row-actions">{0}</ul>',
        res.join('')
    );
};
